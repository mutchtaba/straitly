...
export default function OrbitSystem() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute left-1/2 top-1/2 flex h-28 w-28 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-[radial-gradient(circle,rgba(183,127,90,0.18),rgba(183,127,90,0.05)_55%,transparent_72%)]">
        <div className="animate-halo absolute -inset-7 rounded-full bg-[radial-gradient(circle,rgba(183,127,90,0.16),transparent_65%)]" />
        <svg width="72" height="72" viewBox="0 0 300 300" className="relative">
          <circle
            cx="150"
            cy="150"
            r="130"
      ...
      {CHIPS.map((chip, i) => {
        ...
        return (
          <div
            ...
            className="absolute left-1/2 top-1/2 -ml-7 -mt-7 flex h-14 w-14 items-center justify-center rounded-[15px] border border-warm-gray/30 bg-gradient-to-b from-[#35373c] to-[#2b2d31] shadow-[0_10px_28px_rgba(0,0,0,0.5),inset_0_1px_0_rgba(240,235,226,0.08)] will-change-transform"
            style={s}
          >
